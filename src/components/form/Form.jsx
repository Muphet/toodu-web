...
export default class Form extends Component {
  ...
  onSubmit(e) {
    ...
    this.setState({ submitting: true, errors: null, message: null, flash: null });
  ...
  render() {
    return (
      <form onSubmit={this.onSubmit.bind(this)} className={this.props.className}>
        <FormErrors errors={this.state.errors} className={this.props.className} />
        <FormMessage message={this.state.message} className={this.props.className} />
